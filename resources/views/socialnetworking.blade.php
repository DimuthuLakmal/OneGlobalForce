...
@section('form_1')
<form action='/socialnetworkcomment' method="POST">
...
<div class="col-md-3 col-sm-6 col-xs-12 text-center-xs mb-xs-24">
    <h4 class="uppercase mb0 bold" style="color: white !important">Social Networking</h4>
...
<div class="row">
    ...
    <div class="box box-success"style="display: none" id="texteditor">
        <div class="container">
            <br>
            <form action='/socialnetworkcomment' method="POST" class='form-horizontal'>
                ...
                <input type='hidden' id='topic' name='topic' value='socialnetworking'>
                <div class="form-group">
